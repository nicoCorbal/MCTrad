...
const EmailButton = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-white hover:bg-gray-50 text-gray-900 pl-3 pr-5 py-2.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200">
