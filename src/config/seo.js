...
export const servicePages = {
  ...
  'traduccion-certificado-nacimiento': {
    ...
    seo: {
      es: {
        title: 'Traducción Jurada Certificado de Nacimiento | Alemán-Español | MAEC',
        description: 'Traducciones juradas de certificados y partidas de nacimiento con validez oficial. Traductora acreditada MAEC y OLG Köln. Válida para registro civil, nacionalidad, visados y extranjería. Presupuesto gratis. Entrega 24-48h.',
      ...
      de: {
        title: 'Beglaubigte Übersetzung Geburtsurkunde | Spanisch-Deutsch | OLG Köln',
        description: 'Beglaubigte Übersetzung von Geburtsurkunden mit amtlicher Gültigkeit. Ermächtigt durch OLG Köln und MAEC Spanien. Für Standesamt, Visum und Behörden. Kostenlos Angebot. Lieferung 24-48h.',
        keywords: 'Übersetzung Geburtsurkunde, beglaubigte Geburtsurkunde, Geburtsurkunde übersetzen, spanische Geburtsurkunde',
      },
      fr: {
        title: 'Traduction Assermentée Acte de Naissance | Allemand-Espagnol-Français',
        description: 'Traduction assermentée des actes de naissance avec validité officielle. Traductrice certifiée MAEC et OLG Cologne. Pour mairie, visa et administration. Devis gratuit. Livraison 24-48h.',
        keywords: 'traduction acte naissance, traduire acte naissance, traduction assermentée naissance, acte naissance apostille',
      },
      en: {
        title: 'Certified Birth Certificate Translation | German-Spanish | Official',
        description: 'Certified translation of birth certificates with full legal validity. Sworn translator accredited by MAEC Spain and OLG Cologne Germany. For civil registry, citizenship, visas. Free quote. 24-48h delivery.',
  ...
  'traduccion-certificado-matrimonio': {
    ...
    seo: {
      es: {
        title: 'Traducción Jurada Certificado de Matrimonio | Alemán-Español | MAEC',
        description: 'Traducciones juradas de certificados de matrimonio y actas matrimoniales. Válida para inscripción en Registro Civil, reagrupación familiar, visados y nacionalidad. Traductora oficial MAEC y OLG Köln. Entrega 24-48h.',
      ...
      de: {
        title: 'Beglaubigte Übersetzung Heiratsurkunde | Spanisch-Deutsch | OLG Köln',
        description: 'Beglaubigte Übersetzung von Heiratsurkunden für Standesamt, Familiennachzug und Behörden. Ermächtigt OLG Köln und MAEC. Amtliche Gültigkeit in Deutschland und Spanien. Angebot in 1h.',
        keywords: 'Übersetzung Heiratsurkunde, beglaubigte Heiratsurkunde, Eheurkunde übersetzen, spanische Heiratsurkunde',
      },
      fr: {
        title: 'Traduction Assermentée Acte de Mariage | Allemand-Espagnol-Français',
        description: 'Traduction assermentée des actes de mariage pour inscription état civil, regroupement familial et procédures légales. Traductrice certifiée. Devis gratuit.',
        keywords: 'traduction acte mariage, traduire certificat mariage, acte mariage apostille',
      },
      en: {
        title: 'Certified Marriage Certificate Translation | German-Spanish | Official',
        description: 'Certified translation of marriage certificates for civil registry, family reunification, visas and legal procedures. Sworn translator MAEC and OLG Cologne. 24-48h delivery.',
  ...
  'traduccion-titulo-universitario': {
    ...
    seo: {
      es: {
        title: 'Traducción Jurada Título Universitario | Homologación España-Alemania',
        description: 'Traducciones juradas de títulos universitarios, expedientes académicos y certificados de notas para homologación. Válida ante Ministerio de Educación y universidades. Traductora MAEC y OLG Köln. Entrega 24-72h.',
      ...
      de: {
        title: 'Beglaubigte Übersetzung Hochschulzeugnis | Anerkennung Deutschland',
        description: 'Beglaubigte Übersetzung von Hochschulzeugnissen, Transcripts und Diploma Supplements für Anerkennung ausländischer Abschlüsse. Ermächtigt OLG Köln. Für Universitäten und Arbeitgeber.',
        keywords: 'Übersetzung Hochschulzeugnis, Zeugnis übersetzen, Anerkennung Studienabschluss, spanisches Zeugnis',
      },
      fr: {
        title: 'Traduction Assermentée Diplôme Universitaire | Reconnaissance Espagne-Allemagne',
        description: 'Traduction assermentée de diplômes universitaires et relevés de notes pour reconnaissance des qualifications. Traductrice certifiée MAEC et OLG Cologne.',
        keywords: 'traduction diplôme, traduire diplôme universitaire, reconnaissance diplôme',
      },
      en: {
        title: 'Certified University Degree Translation | Spain-Germany Recognition',
        description: 'Certified translation of university degrees, academic transcripts and diploma supplements for credential recognition. Sworn translator MAEC and OLG Cologne. 24-72h delivery.',
  ...
  'traduccion-contratos': {
    ...
    seo: {
      es: {
        title: 'Traducción Jurada de Contratos | Alemán-Español | Mercantil y Laboral',
        description: 'Traducciones juradas de contratos mercantiles, laborales, compraventa, arrendamiento y NDAs. Precisión jurídica adaptada al derecho español y alemán. Válida ante tribunales y notarías. Entrega 24-48h.',
        keywords: 'traducción contratos, traducir contrato alemán, traducción jurada contrato, contrato trabajo alemán, NDA traducción',
      },
      de: {
        title: 'Beglaubigte Übersetzung Verträge | Spanisch-Deutsch | Handels- und Arbeitsrecht',
        description: 'Beglaubigte Übersetzung von Kauf-, Arbeits- und Handelsverträgen mit juristischer Präzision. Angepasst an deutsches und spanisches Recht. Für Gerichte und Notare gültig.',
        keywords: 'Übersetzung Vertrag, Vertrag übersetzen, beglaubigte Vertragsübersetzung, Arbeitsvertrag Spanisch',
      },
      fr: {
        title: 'Traduction Assermentée Contrats | Allemand-Espagnol | Commercial et Travail',
        description: 'Traduction assermentée de contrats commerciaux, de travail et juridiques avec précision terminologique. Valide devant tribunaux et notaires.',
        keywords: 'traduction contrat, traduire contrat, contrat travail traduction',
      },
      en: {
        title: 'Certified Contract Translation | German-Spanish | Commercial and Employment',
        description: 'Certified translation of commercial, employment, sales and lease contracts with legal precision. Adapted to Spanish and German law. Valid for courts and notaries. 24-48h delivery.',
  ...
  'traduccion-sentencias-judiciales': {
    ...
    seo: {
      es: {
        title: 'Traducción Jurada Sentencias Judiciales | Alemán-Español | Tribunales',
        description: 'Traducciones juradas de sentencias, autos, resoluciones judiciales y exhortos internacionales. Válida ante tribunales españoles y alemanes. Servicio urgente disponible para plazos procesales. Entrega express mismo día.',
      ...
      de: {
        title: 'Beglaubigte Übersetzung Gerichtsurteile | Spanisch-Deutsch | Gerichte',
        description: 'Beglaubigte Übersetzung von Gerichtsurteilen, Beschlüssen und Rechtshilfeersuchen. Gültig bei deutschen und spanischen Gerichten. Eilservice für Prozessfristen verfügbar.',
        keywords: 'Übersetzung Gerichtsurteil, Urteil übersetzen, beglaubigte Gerichtsübersetzung, Scheidungsurteil Spanisch',
      },
      fr: {
        title: 'Traduction Assermentée Jugements | Allemand-Espagnol | Tribunaux',
        description: 'Traduction assermentée de jugements, ordonnances et commissions rogatoires. Valide devant tribunaux espagnols et allemands. Service urgent disponible.',
        keywords: 'traduction jugement, traduire décision justice, commission rogatoire',
      },
      en: {
        title: 'Certified Court Judgment Translation | German-Spanish | Legal Proceedings',
        description: 'Certified translation of court judgments, rulings, and letters rogatory for international legal proceedings. Valid before Spanish and German courts. Rush service available. Same-day delivery.',
  ...
  'traduccion-documentos-notariales': {
    ...
    seo: {
      es: {
        title: 'Traducción Jurada Documentos Notariales | Alemán-Español | Escrituras y Poderes',
        description: 'Traducciones juradas de escrituras públicas, poderes notariales, testamentos y capitulaciones matrimoniales. Válida ante notarios españoles y alemanes. Para compraventa inmuebles, herencias y trámites. Entrega 48-72h.',
      ...
      de: {
        title: 'Beglaubigte Übersetzung Notarielle Dokumente | Spanisch-Deutsch | Urkunden',
        description: 'Beglaubigte Übersetzung von notariellen Urkunden, Vollmachten, Testamenten und Eheverträgen. Gültig bei deutschen und spanischen Notaren. Für Immobilienkauf, Erbschaft und Behörden.',
        keywords: 'Übersetzung Vollmacht, notarielle Urkunde übersetzen, Testament Spanisch, Kaufurkunde übersetzen',
      },
      fr: {
        title: 'Traduction Assermentée Actes Notariés | Allemand-Espagnol | Procurations',
        description: 'Traduction assermentée d\'actes notariés, procurations, testaments et contrats de mariage. Valide devant notaires espagnols et allemands. Pour immobilier et successions.',
        keywords: 'traduction acte notarié, traduire procuration, testament traduction, acte vente',
      },
      en: {
        title: 'Certified Notarial Document Translation | German-Spanish | Deeds and Powers',
        description: 'Certified translation of notarial deeds, powers of attorney, wills, and prenuptial agreements. Valid before Spanish and German notaries. For real estate, inheritance, and legal procedures. 48-72h delivery.',
